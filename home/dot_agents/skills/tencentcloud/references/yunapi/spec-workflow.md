...
- Source priority: current artifact and repository evidence first, then `spec.md`, then upstream/official docs if explicitly supplied. Do not use memory as authority.
...
1. Read `spec.md` before making any normative call.
...
- Leaving review conclusions without rule evidence from `spec.md`.

## Resources

- `spec.md`: detailed YunAPI 3.0 rules and review checklist extracted from the attached source document.
