...
2. 按场景加载一份或多份参考：
   - 选型、建项目、配置建模、发布：读 [usage.md](usage.md)
   - SDK、Agent、trpc、OpenAPI、GitOps：读 [integration.md](integration.md)
   - 七彩石自身开发、测试与架构：读 [development.md](development.md)
   - 运维、多集群、容灾与变更：读 [operations.md](operations.md)
   - 报错、异常、未生效、性能问题：读 [troubleshooting.md](troubleshooting.md)
3. 需要具体参数或最新结论时，用 `iwiki-cli get <docid>` 回源；不知道文档时用 `iwiki-cli search "关键词" --space-keys peizhizhongxin`。资料入口见 [source-map.md](source-map.md)。
