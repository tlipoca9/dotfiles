...
- **Opaque InternalError:** invoke `tencentcloud-yunapi-gateway-request-id-escalation`; preserve the escalation packet and stop speculative response-shape edits.
