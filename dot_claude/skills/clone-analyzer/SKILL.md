...
When a GitHub repository is referenced (URL, `org/repo` format, or by name), I clone it locally for thorough analysis using local file tools (Read, Grep, Glob) rather than relying on web-based browsing or API calls.
